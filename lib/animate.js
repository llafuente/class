(function (exports, browser) {
                ...
                for (i = 0; i < max; ++i) {
                    if (fvalue[i] <= factor) {
                        ...
                        if (found === true) {
                            ...
                            tfactor = (factor - fvalue[i]) / (fvalue[i + 1] - fvalue[i]);

                            return rebuild_property(this, property, ovalue[kvalue[i]][property], ovalue[kvalue[i + 1]][property], tfactor);
                        }
                    }
                }
            }.bind(this);
    ...
    Animate.hide(["$__animation_interval", "$__animating", "$__animation_linking"]);
