(function (exports, browser) {
    ...
    var Class = browser ? exports.Class : require("./class.js").Class,
        ...
        typeOf = browser ? exports.typeof : require("./class.js").typeof,
        typeOf = browser ? exports.typeof : require("./class.js").typeof,
    ...
    Animate.implements({
        ...
        *     {"0%": 50, "100%": 100}: could be an object with a percentage in its keys (sorted is mandatory!)
        */
        animate: function (options, value) {
            ...
            function update() {
                ...
                if (tfactor === 1) {
                    ...
                    //animation end!
                    this.emit("animation:end", [animation, this]);

                    this.emit("$__animation:end");
                } else {
                    this.emit("animation:update", [animation, this]);
                }
            }
            ...
            this.$__animation_interval = update.periodical(animation.fps, this);
        },
        isAnimated: function () {
            return this.$__animation_interval !== null;
        },
        ...
        // chain
        // stop
        setAnimationLink: function() {
            // todo ?
        },
        chainAnimation: function(options, value) {
            if(this.isAnimated()) {
                this.once("$__animation:end", function() {
