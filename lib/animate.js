    ...
    Animate.implements({
        ...
        */
        animate: function (options, value) {
            ...
            update_function = function (delta) {
                var now = +(new Date),
            ...
            if (options.fps) {
                options.fps = Math.round(1000 / options.fps) || 85;
                this.$__animation_interval = function () {
                    this.emit("tick", []);
                }.periodical(animation.fps, this);
            }

            this.on("tick", update_function);
        },
        isAnimated: function () {
        ...
        /**
         * @returns Boolean true if chained false otherwise
         */
