(function (exports, browser) {
    ...
    exports.Events.Implements({
        ...
        emit: function (event, args, delay_ms) {
            ...
            for (i = 0; i < max; ++i) {
                ...
                if (!fn) {
                continue;
                    throw new Error("Events[" + event + "] Did You remove a listener while looping!? then -> use Eventize.remove to do that!");
                }
                // </debug>
    ...
    exports.Events.alias("on", "addListener");
    exports.Events.alias("off", "removeListener");
    exports.Events.alias("listeners", "getListeners");
