    ...
    */
    ...
    Class = function (name, properties, methods) {
        ...
        var $self, // this points to the base object, used to check some
            ...
            $autoset = true,
            $childs = [],
            $fast_constructor = false;

        // constructor
        $self = function (options, arg2, arg3, arg4) {
            if($fast_constructor === true) {
                //console.log(name, "fast-constructor");
                // constructor
                if (this.__construct) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        this.__construct(options, arg2);
                        break;
                    case 3:
                        this.__construct(options, arg2, arg3);
                        break;
                    case 4:
                        this.__construct(options, arg2, arg3, arg4);
                        break;
                    default:
...
*/
            ...
            for (i = 0; i < max; ++i) {
                ...
                descriptor = __clone_descriptors($data_descriptors[k]);
                //console.log("__clone_descriptors", descriptor);
                //descriptor = __clone($data_descriptors[k]);
                //console.log("__clone", descriptor);
        ...
        */
        ...
        /**
         * Disable property features (like hidden) this improve constructor speed
         * @note there is no reverse method for security reasons
         */
        $self.fast_constructor = function () {
            $fast_constructor = true;
        ...
        $self.__set = function (proto, p_name, p_value, descriptor, must_be_function) {
            ...
            if (must_be_function && $abstract_methods.indexOf(p_name) !== -1 && target[p_name] && target[p_name].length !== p_value.length) {
                ...
                throw new Error(name + "::" + p_name + " is abstract and the parameter count is different");
            }
            //</debug>
