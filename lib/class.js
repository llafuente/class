    ...
    (function () {
        $.Class = function (name, properties, methods) {
            ...
            */
             ...
             * properties({vector: {y:0}}); // set vector with only "y"
             * properties({vector: {y:0}}, true); // add y to the vector, so xy :)
             *
             * @param Object properties
             * @param Boolean recursive use it when you want to add more properties to existing "object properties"
             * @returns this for chaining
             */
            $self.properties = function (properties, recursive) {
                ...
                if (recursive) {
                    Object.merge(this.prototype, properties, false, true, true);
                }
