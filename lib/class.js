(function (exports) {
    ...
    exports.$class = __class = function (name, extend, implement, initialize, autoset, seal) {
            ...
            if (prop.length) {
                ...
                if (!autoset || !options) {
                    for (i = 0, max = prop.length; i < max; ++i) {
                        ...
                        name = prop[i];
                        if ("object" === descriptor.type.__ || "array" === descriptor.type.__) {
                            this[name] = __typed_clone(this[name], descriptor.type);
                        }

                        if (descriptor.configurable === false) {
                            if (descriptor.get === undefined && descriptor.set === undefined) {
                                descriptor.value = this[name];
                            }
                    ...
                    for (i = 0, max = prop.length; i < max; ++i) {
                        ...
                        if (descriptor.configurable === false) {
                            if (descriptor.get === undefined && descriptor.set === undefined) {
                                descriptor.value = __typed_clone_or_merge(this[name], options[name], descriptor.type);
                            }
                            clon_desc = __clone_descriptors(descriptor);
        ...
        defineProperty($self, "properties", {
            value: [],
            writable : true,
            enumerable : enum_class_props,
            configurable : false
        ...
        defineProperty($self, "descriptors", {
            value: [],
            writable : true,
            enumerable : enum_class_props,
            configurable : false
        ...
        defineProperty($self, "config_property", {
    ...
    exports.property = __property = function ($class, name, _default, meta) {
        ...
        if (meta) {
            ...
            // check if need defineProperty
            if (meta.enumerable === false || //no default
                meta.writable === false || //no default
                meta.get !== undefined || // check function ?
                meta.set !== undefined) { // check function ?
