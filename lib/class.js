(function (exports) {
            ...
            if (prop.length) {
                ...
                if (!autoset || !options) {
                    for (i = 0, max = prop.length; i < max; ++i) {
                        ...
                        name = prop[i];
                        //console.log("without options", i, name, descriptor, this[name]);
                    ...
                    for (i = 0, max = prop.length; i < max; ++i) {
                        descriptor = descriptors[i];
                        name = prop[i];
                        //console.log("with options", i, name, descriptor);
    ...
    exports.accessor = __accessor = function ($class, name, meta) {
        ...
        if ("function" === typeof meta.get) {
            throw new Error("meta.get must be a function");
        }

        if ("function" === typeof meta.set) {
