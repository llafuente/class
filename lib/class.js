(function (exports, browser) {
    ...
    module.exports.__typed_clone = __typed_clone = function (obj, types) {
        var i,
            type,
            ar,
            cobj,
    ...
    module.exports.__typed_clone_or_merge = __typed_clone_or_merge = function (obj, merge, types) {
        var i,
            type,
            ar,
            cobj,
    ...
    module.exports.__rtypeof = __rtypeof = function (obj) {
    ...
    module.exports.$class = __class = function (name, extend, implement, initialize) {
        if (classes[name]) {
        ...
        $self = function (options) {
            ...
            if (prop.length) {
                ...
                if (!autofill || !options) {
                    for (i = 0, max = prop.length; i < max; ++i) {
                        d = desc[i];
                        name = prop[i];
                        if(d.type.__ == "object" || d.type.__ == "array") {
            ...
            if (this.initialize) {
                ...
                case 1: this.initialize(arguments[0]); break;
                case 2: this.initialize(arguments[0], arguments[1]); break;
                case 3: this.initialize(arguments[0], arguments[1], arguments[2]); break;
                case 4: this.initialize(arguments[0], arguments[1], arguments[2], arguments[3]); break;
                default:
    ...
    module.exports.abstract = __abstract = function ($class, name, method) {
    ...
    module.exports.get_abstract = __get_abstract = function ($class, name) {
        var i,
            max,
            abs = $class.abstracts;
    ...
    module.exports.__config_property = __config_property = function($class, name, inlist) {
        var list = function() {
                var i;
                for (i in inlist) {
                    this[i] = inlist[i];
        ...
        Object.each(inlist, function(v, k) {
            ...
            defineProperty(list.prototype, k.toUpperCase(), {
                get: function() {
                    this[k] = !this[k];
                    return this;
                }
    ...
    module.exports.property = __property = function ($class, name, _default, meta) {
    ...
    module.exports.method = __method = function ($class, name, method) {
        ...
        if ($class.methods.indexOf(name) !== -1) {
            ...
            $class.prototype[name] = function () {
                ...
                switch (arguments.length) {
                case 0: ret = method.call(this); break;
                case 1: ret = method.call(this, arguments[0]); break;
                case 2: ret = method.call(this, arguments[0], arguments[1]); break;
                case 3: ret = method.call(this, arguments[0], arguments[1], arguments[2]); break;
                case 4: ret = method.call(this, arguments[0], arguments[1], arguments[2], arguments[3]); break;
                default:
    ...
    module.exports.extends = __extends = function ($class, implement) {
    ...
    module.exports.class = function(name, options) {
        var _extends = options.extends || [],
            _implements = options.implements || [],
        ...
        cls = __class(name, _extends, _implements);
